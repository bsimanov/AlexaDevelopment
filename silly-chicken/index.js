...
function handleWhyRequest(response) {
    var WhyResponses = [
        "Because, chicken!",
...
function handleWhoRequest(intent, response) {
    var slots = intent.slots;
    var isOrAre = null;

    if (slots && slots.isOrAre)
        isOrAre = slots.isOrAre.value;

    var speechText, repromptText;

    if (isOrAre == "is") {
        speechText = "I'd say you, you sound like a chicken";
        repromptText = "What else would you like to know??";
    } else if (isOrAre == "are") {
        speechText = "You're one of those chickens!";
        repromptText = "What else would you like to know??";
    } else {
        speechText = "In the Who Intent, but no clue if is or are";
        repromptText = "Anything else you want?";
    }
...
function handleJokeRequest(response) {
    var JOKES = [
        "How long do chickens work? Around the cluck!",
        "Why Did The Chicken Cross The Playground? To Get To The Other Slide.",
        "Why did the checken cross the road? To get to the other side, silly",
    ...
    var speechOutput = randomJoke;
    var cardTitle = "Your Joke";
 ...
 */
function handleInformationRequest(response) {
    var INFO = [
    ...
    // Create speech output
    var speechOutput = "Here's some interesting info: " + randomInfo;
    var cardTitle = "Your Info";
    response.tellWithCard(speechOutput, cardTitle, speechOutput);
}
